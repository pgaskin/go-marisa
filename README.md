...
This library wraps a WebAssembly build of MARISA transpiled to Go using [wasm2go](https://github.com/ncruces/wasm2go).
...
In general, it is about 1.5-3x slower than the native library.
...
The wasm2go blob is fully [reproducible](./src/Dockerfile) and [verified](https://github.com/pgaskin/go-marisa/attestations).
